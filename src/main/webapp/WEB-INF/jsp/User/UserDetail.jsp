        ...
        <form style="TEXT-ALIGN: center" id=userForm method=post name=userForm action="userdetail?procflg=0&userId=232">
            <div style="width: 1158px; height: 30px">
                <div style="BACKGROUND-IMAGE: url(${pageContext.request.contextPath}/static/Image/006.jpg); TEXT-ALIGN: left; MARGIN-TOP: 20px; TEXT-INDENT: 20px; width: 65%; BACKGROUND-REPEAT: no-repeat; float: left; height: 28px">
                    <span  id=ctl00_lbltitle class=title>ユーザー詳細</span>
                </div>
            </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="width: 170px"><span id=ctl00_mainContent_lblUserName class=labelBld>ユーザー名</span><br>
                                        <input style="width: 120px" id="userName" class=textBoxReadOnly name="userName" readOnly maxLength=20 value="${userInfo.userName}">
                                    </td>
                                    <td style="width: 170px"><span id=ctl00_mainContent_lblPassword class=inputlbl>パスワード</span><br>
                                        <input style="width: 120px" id="password" class=textBoxReadOnly name="password" readOnly maxLength=20 type=password value="${userInfo.password}">
                                    </td>
                                    <td style="width: 170px"><span id=ctl00_mainContent_lblRPassword class=inputlbl>パスワード確認</span><br>
                                        <input style="width: 120px" id="rpassword" class=textBoxReadOnly name="rpassword"  readOnly maxLength=20 type=password value="${userInfo.password}">
                                    </td>
                                </tr>
                                <tr>
                                    <td colSpan=2><span id=ctl00_mainContent_lblPhone class=inputlbl>電話番号</span><br>
                                        <input style="width: 300px" id="telNumber" class=textBoxReadOnly name="telNumber"  readOnly maxLength=80 value="${userInfo.telNumber}">
                                    </td>
                                    <td colSpan=2><span id=ctl00_mainContent_lblEmail class=inputlbl>メールアドレス</span><br>
                                        <input style="width: 300px" id="mailAddress" class=textBoxReadOnly name="mailAddress" readOnly maxLength=50 value="${userInfo.mailAddress}">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <textarea style="width: 480px; height: 50px" id="memo" class=textBoxReadOnly readOnly name="memo">${userInfo.memo}</textarea>
                                    </td>
                    ...
                    <table style="width: 100%; MARGIN-BOTTOM: 5px; MARGIN-LEFT: 5px; MARGIN-RIGHT: -5px" border=0 cellSpacing=0 cellPadding=0>
                        <tbody>
                            <tr>
                                ...
                                <td style="width: 170px"><span id=ctl00_mainContent_lblUpdateBy class=inputlbl>更新者</span><br>
